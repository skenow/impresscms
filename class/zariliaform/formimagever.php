...
/**
 *
 * @version $Id: formimagever.php,v 1.1 2007/03/16 02:40:58 catzwolf Exp $
 * @copyright 2006
 */
class ZariliaFormImagever extends ZariliaFormElement {
    /**
     ...
     */
    function ZariliaFormImagever( $caption, $name, $size, $maxlength, $value = "", $bgimage = "" )
    {
