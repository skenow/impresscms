<?php
// $Id: formselectlist.php,v 1.1 2007/03/16 02:40:58 catzwolf Exp $
// ------------------------------------------------------------------------ //
 ...
 * @copyright copyright (c) 2007 Zarilia Project - http.www.zarilia.com
 */
class ZariliaFormSelectList extends ZariliaFormSelect
{
	/**
	 * Constructor
	 * 
	 ...
	 */
	function ZariliaFormSelectList($caption, $name, $value=null, $size=1, $handler, $addon=null)
	{
	    $multiple = $size > 1;
		$this->ZariliaFormSelect($caption, $name, $value, $size, $multiple);
		$handler =& zarilia_getaddonhandler($handler, $addon);
