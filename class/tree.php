<?php
// $Id: tree.php,v 1.2 2007/04/22 07:21:32 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
class ZariliaObjectTree {
     ...
     */
    function ZariliaObjectTree( &$objectArr, $myId, $parentId, $rootId = null ) {
     ...
     */
    function makeSelBox( $name, $fieldName, $prefix = '-', $selected = '', $addEmptyOption = true, $key = 0, $return = true ) {
