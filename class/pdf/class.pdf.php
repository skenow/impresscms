...
* Each function has the same call list ($id,$op,$options).
* $id = the object ID of the object, or what it is to be if it is being created
* $op = a string specifying the action to be performed, though ALL must support:
...
*/
function o_destination($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch($op){
...
*/
function o_viewerPreferences($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_catalog($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_pages($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_outlines($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_fontDescriptor($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
* the font encoding
*/
function o_fontEncoding($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_procset($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_action($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
    case 'new':
      if (is_array($options)){
        $this->objects[$id]=array('t'=>'op','info'=>$options,'type'=>$options['type']);
      } else {
        // then assume a URI action
        $this->objects[$id]=array('t'=>'op','info'=>$options,'type'=>'URI');
      }
      break;
    case 'out':
      if ($this->encrypted){
...
*/
function o_annotation($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_contents($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch ($op){
...
*/
function o_image($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch($op){
...
* encryption object.
*/
function o_encryption($id,$op,$options=''){
  if ($op!='new'){
    $o =& $this->objects[$id];
  }
  switch($op){
