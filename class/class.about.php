<?php
// $Id: class.about.php,v 1.1 2007/03/16 02:38:58 catzwolf Exp $
// ------------------------------------------------------------------------ //
 ...
 * @version $Id: class.about.php,v 1.1 2007/03/16 02:38:58 catzwolf Exp $
 * @access public
 */
class ZariliaAbout {
    /**
     * ZariliaAbout::ZariliaAbout()
     *
     * @param string $aboutTitle
     */
    function ZariliaAbout() {
    ...
    /**
     * ZariliaAbout::userAddon()
     *
     * @return
     */
    function userAddon() {
        Global $zariliaAddon, $addonversion;

        $addon_handler = &zarilia_gethandler( 'addon' );
        $versioninfo = &$addon_handler->get( $zariliaAddon->getVar( 'mid' ) );
    }
}
