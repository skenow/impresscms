<?php
// $Id: ZariliaStory.php 184 2006-01-22 22:34:51Z skalpa $
//  ------------------------------------------------------------------------ //
...
//include_once ZAR_ROOT_PATH."/class/ZariliaUser.php";
...
class ZariliaStory
{
	...
	function topic()
	{
		return new ZariliaTopic($this->topicstable, $this->topicid);
	}
	...
	function uname()
	{
		return ZariliaUser::getUnameFromId($this->uid);
	}
