<?php
// $Id: themesetparser.php,v 1.1 2007/03/16 02:40:55 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
include_once ZAR_ROOT_PATH.'/class/xml/saxparser.php';
include_once ZAR_ROOT_PATH.'/class/xml/xmltaghandler.php';

class ZariliaThemeSetParser extends SaxParser
{
	var $tempArr = array();
	...
	function ZariliaThemeSetParser(&$input)
	{
		...
		$this->addTagHandler(new ThemeSetAddonHandler());
...
class ThemeSetAddonHandler extends XmlTagHandler
{
	function ThemeSetAddonHandler()
	{
