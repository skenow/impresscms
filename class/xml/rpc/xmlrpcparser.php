<?php
// $Id: xmlrpcparser.php,v 1.1 2007/03/16 02:42:17 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
* @author    Kazumi Ono
* @version   1.6 ($Date: 2007/03/16 02:42:17 $) $Revision: 1.1 $
* @access    public
*/

class ZariliaXmlRpcParser extends SaxParser
{
    ...
    * @see
    */
    function ZariliaXmlRpcParser(&$input)
    {
