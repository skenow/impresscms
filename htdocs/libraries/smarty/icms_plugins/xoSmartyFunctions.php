...
function XoSmartyPluginGetSection( $section = '' ) {
	...
	if ( file_exists( ICMS_TRUST_PATH . "/xorewrite/$section.ini.php" ) ) {
		$config_file = $section;
	}
	if ( file_exists( ICMS_TRUST_PATH . "/xorewrite/$config_file.ini.php" ) ) {
		$IniContent = parse_ini_file( ICMS_TRUST_PATH . "/xorewrite/$config_file.ini.php", true);
		if ( !empty($section) ) {
