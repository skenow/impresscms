...
class icms_ipf_view_Single {
	...
	public function render($fetchOnly = false, $debug = false) {
		...
		foreach ($this->_rows as $row) {
			...
			if ($row->isHeader()) {
				$this->_tpl->assign('icms_single_view_header_caption', $this->_object->_vars[$key]['form_caption']);
				...
				$icms_object_array[$key]['caption'] = $this->_object->_vars[$key]['form_caption'];
			}
		}
		$action_row = '';
