 ...
 * icms_ipf_Registry
 *
 * The icms_ipf_Registry is an object containing icms_ipf_Object objects that will be reused in the same process
 *
 ...
 * @version		$Id: icmspersistableobjectsregistry.php 19623 2010-06-25 14:59:15Z malanciault $
 */

if (!defined("ICMS_ROOT_PATH")) die("ImpressCMS root path not defined");

class icms_ipf_Registry {
	...
	function &getInstance()
	{
		static $instance;
		if (!isset($instance)) {
			$instance = new icms_ipf_Registry();
		}
		return $instance;
	}
