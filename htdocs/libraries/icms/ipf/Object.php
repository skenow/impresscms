...
class icms_ipf_Object extends icms_core_Object {
	 ...
	 *        Handler that linked to this object
	 * @param array $data
	 *        used when loading/creating object
	 */
	...
	public function serialize() {
		$data = array(
				'vars' => parent::getValues(),
				'handler' => array('module' => $this->handler->_moduleName,'itemname' => $this->handler->_itemname)
		);
