...
class icms_view_Tpl extends Smarty {
    ...
    protected $_controlHandler;
    protected $_controls = array();
    protected $_controlsNum = 0;
    protected $_controlsIndexes = array();
    public $autoload_filters = array('post' => array('control'));

    public function __construct() {
        global $icmsConfig;

        $this->_controlHandler = new icms_controls_Handler();
        $this->register_compiler_function("/control", "smarty_compiler_endcontrol");
