 ...
 * @version		$Id: Object.php 11420 2011-10-25 03:14:27Z skenow $
 * @category	ICMS
 * @package		View
 * @subpackage 	Theme
 */
...
class icms_view_theme_Object {
	...
	public function xoInit($options = array()) {
        ...
        $manifest_handler = icms_cache_Manifest::getInstance();
        $manifest_handler->add(ICMS_URL . '/getconfig.php', icms_cache_Manifest::TYPE_CACHE);
        $this->addScript(ICMS_URL . '/getconfig.php');

		global $icmsConfig, $icmsConfigMetaFooter, $icmsModule, $xoopsModule;
		$this->template->assign(
			array(
                'icms_manifest' => $manifest_handler->getURL(),
