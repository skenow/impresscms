...
/*
$icmsTpl->assign('image_name',$image->getVar('imgcat_name'));
$icmsTpl->assign('image_nicename',$image->getVar('imgcat_nicename'));

$icmsTpl->assign('crop_script',$crop_script);
$icmsTpl->assign('imageWidth',$imageWidth);
$icmsTpl->assign('imageHeight',$imageHeight);
$icmsTpl->assign('image',$image);
$icmsTpl->assign('image_id',$image_id);
$icmsTpl->assign('image_name',$image_name);
$icmsTpl->assign('image_title',$image_title);
$icmsTpl->assign('uniq',$uniq);
$icmsTpl->assign('type',$type);
$icmsTpl->assign('target',$target);
$icmsTpl->assign('imageExt',$imageExt);
*/
$icmsTpl->assign('lang_ie_title',_IMGMANAGER);
$icmsTpl->assign('lang_width',_WIDTH);
$icmsTpl->assign('lang_height',_HEIGHT);
$icmsTpl->assign('lang_preview',_PREVIEW);
$icmsTpl->assign('lang_submit',_SUBMIT);
$icmsTpl->assign('lang_cancel',_CANCEL);
$icmsTpl->assign('lang_dimension',_DIMENSION);
$icmsTpl->assign('lang_overwrite',_IMAGEFILTERSSAVE);
$icmsTpl->assign('lang_yes',_YES);
$icmsTpl->assign('lang_no',_NO);
$icmsTpl->assign('lang_imagename',_IMAGENAME);
$icmsTpl->assign('lang_imageweight',_IMGWEIGHT);
$icmsTpl->assign('lang_imagedisplay',_IMGDISPLAY);
$icmsTpl->assign('lang_instructions',_INSTRUCTIONS);
$icmsTpl->assign('lang_instructions_dsc',_INSTRUCTIONS_DSC);
$icmsTpl->assign('lang_croptool',_CROPTOOL);
$icmsTpl->assign('lang_imgdetails',_IMGDETAILS);
