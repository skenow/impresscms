...
* @version		$Id: mainfile.php 19450 2010-06-18 14:15:29Z malanciault $
*/
...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/home/marcan/dev/impresscms_1.3_autoload/htdocs' );
	define( 'XOOPS_ROOT_PATH', '/home/marcan/dev/impresscms_1.3_autoload/htdocs' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/home/marcan/dev/impresscms_1.3_autoload/trust_path' );
	define( 'XOOPS_TRUST_PATH', '/home/marcan/dev/impresscms_1.3_autoload/trust_path' );

	include_once XOOPS_TRUST_PATH . '/fa4c5d2ac21a858bd7c3aac31db071d5.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://inbox2.local/impresscms_1.3_autoload/htdocs' );
	define( 'XOOPS_URL', 'http://inbox2.local/impresscms_1.3_autoload/htdocs' );
