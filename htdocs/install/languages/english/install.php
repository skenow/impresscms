...
define('_PATH_NOT_WRITABLE', "Path '%s' is not writable. Please change permissions");
define('_DATABASE_UNAVAILABLE', "Database '%s' is not available and could not be created");
define('_PHP_VERSION_FAIL', 'Your version of PHP (%s) does not meet the minimum requirements. You need to have %s or higher');
define('_SERVER_REQUIREMENTS_NOT_MET', 'Environment Requirements not met');
