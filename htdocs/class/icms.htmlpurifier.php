	...
	**/
	function icms_html_purifier($html, $config = 'system-global')
	{
		...
		$HTML_Allowed = 'a[href|title|target|rel], abbr[title], acronym[title], b, blockquote[cite], br, caption, cite, code, dd,
					del, dfn, div[align|style], dl, dt, em, font, h1, h2, h3, h4, i, img[src|alt|title|class|align|style], ins, kbd, li, ol, p[style], pre, s, span[style], strike, strong, sub, sup, table, tbody, td, tfoot, th, thead, tr, tt, u, ul, var';
