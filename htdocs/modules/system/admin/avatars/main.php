...
if ( !is_object($icmsUser) || !is_object($icmsModule) || !$icmsUser->isAdmin($icmsModule->mid()) ) {
	...
	if ($op == 'list') {
		...
		$savatar_count = $avt_handler->getCount(new icms_core_Criteria('avatar_type', 'S'));
		$cavatar_count = $avt_handler->getCount(new icms_core_Criteria('avatar_type', 'C'));
	...
	if ($op == 'listavt') {
		...
		echo '</div><br /><br /><br />';
		$criteria = new icms_core_Criteria('avatar_type', $type);
