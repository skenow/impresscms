...
function imanager_listimg($imgcat_id,$start=0) {
	...
	$icmsAdminTpl->assign('lang_image_applyfilters',_IMAGEAPPLYFILTERS);
	$icmsAdminTpl->assign('lang_image_filterssave',_IMAGEFILTERS);
    ...
    $icmsAdminTpl->assign('filters',$filters);
