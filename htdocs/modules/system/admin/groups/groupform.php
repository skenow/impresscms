...
$criteria = new core_CriteriaCompo(new core_Criteria('hasadmin', 1));
$criteria->add(new core_Criteria('isactive', 1));
$criteria->add(new core_Criteria('dirname', 'system', '<>'));
...
if (!in_array(XOOPS_GROUP_ADMIN, $groups)){
	...
	$criteria->add(new core_Criteria('mid', '('.implode(',',$a_mod).')', 'IN'));}
	...
	if (!in_array(XOOPS_GROUP_ADMIN, $groups)){
		...
		$criteria->add(new core_Criteria('mid', '('.implode(',',$r_mod).')', 'IN'));}
		...
		$criteria = new core_CriteriaCompo(new core_Criteria('isactive', 1));
		...
		if (!in_array(XOOPS_GROUP_ADMIN, $groups)){
			...
			$criteria->add(new core_Criteria('mid', '('.implode(',',$ed_mod).')', 'IN'));}
			...
			if (!in_array(XOOPS_GROUP_ADMIN, $groups)){
				...
				$criteria->add(new core_Criteria('mid', '('.implode(',',$debug_mod).')', 'IN'));}
