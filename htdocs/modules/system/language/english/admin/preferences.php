...
define("_MD_AM_AUTHOPENIDDSC","Select Yes to enable OpenID authentication. This will allow users to login on the site using their OpenID account. For complete information about the OpenID Integration in ImpressCMS, please visit <a href='httpss://wwwimpresscms.org/modules/simplywiki/index.php?page=ImpressCMS_OpenID'>our wiki</a>.");
