 ...
 */
class icms_ipf_TreeTable extends icms_ipf_view_Table {

	function icms_ipf_TreeTable(&$objectHandler, $criteria=false, $actions=array('edit', 'delete'), $userSide=false)
	{
