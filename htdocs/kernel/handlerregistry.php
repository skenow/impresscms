...
/**
 * A registry for holding references to {@link icms_core_ObjectHandler} classes
 *
 * @package     kernel
 *
 * @author	    Kazumi Ono	<onokazu@xoops.org>
...
class XoopsHandlerRegistry
{
	 ...
	 * @param	object  &$handler {@link icms_core_ObjectHandler} class object
	 */
	 ...
	 * @param	string  $name     Short name of a handler class
	 *
	 * @return	object {@link icms_core_ObjectHandler}, FALSE if not registered
	 */
