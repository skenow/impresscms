...
if (isset($_POST['openid_register'])) {
	...
	*/
	...
	$newUser->setVar('openid', $cid);
	if (!$member_handler->insertUser($newUser)) {
		redirect_header($redirect_url, 3, _US_OPENID_NEW_USER_CANNOT_INSERT);
	}
	...
	redirect_header($redirect_url, 3, sprintf(_US_LOGGINGU, $newUser->getVar('uname')));
