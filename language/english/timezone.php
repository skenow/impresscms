<?php
// $Id: timezone.php,v 1.1 2007/03/16 02:44:25 catzwolf Exp $
//%%%%%		Time Zone	%%%%
define("_TZ_GMTM12", "(GMT-12:00) International Date Line West");
...
define("_TZ_GMTM35", "(GMT-3:30) St. John`s, Newfoundland and Labrador");
...
define("_TZ_GMT0", "(GMT) Western Europe Time, London, Lisbon, Casablanca");
define("_TZ_GMTP1", "(GMT+1:00) Berlin, Brussels, Copenhagen, Madrid, Paris");
define("_TZ_GMTP2", "(GMT+2:00) Kaliningrad, South Africa");
define("_TZ_GMTP3", "(GMT+3:00) Baghdad, Riyadh, Moscow, St. Petersburg<");
...
define("_TZ_GMTP8", "(GMT+8:00) Beijing, Perth, Singapore, Hong Kong");
define("_TZ_GMTP9", "(GMT+9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk");
define("_TZ_GMTP95", "(GMT+9:30) Adelaide, Darwin, Yakutsk");
define("_TZ_GMTP10", "(GMT+10:00) Eastern Australia, Guam, Vladivostok");
