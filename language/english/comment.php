<?php
// $Id: comment.php,v 1.1 2007/03/16 02:44:24 catzwolf Exp $
define('_CM_COM_TITLE','Title');
define('_CM_COM_ID','ID');
define('_CM_COM_ICON','Icon');
define('_CM_COM_POSTED','Posted');
define('_CM_COM_POSTER','Poster');
define('_CM_COM_IP','IP');
define('_CM_COM_MODID','Addons');
define('_CM_COM_STATUS','Status');
define('_CM_ACTION','Action');

define('_MA_AD_ICO_EDIT_LEG','Edit Comment');
define('_MA_AD_ICO_DELETE_LEG','Delete Comment');
...
define('_CM_DOXCODE','Enable ZARILIA Codes');
