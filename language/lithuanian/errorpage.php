 ...
 */
define( '_ERR_TITLE_400', '%ss Bloga užklausa' );
define( '_ERR_TITLE_DESC_400', 'Užklausa nebuvo suprasta serverio. Klientas turi pabandyti be adreso modifikacijų.' );
define( '_ERR_TITLE_401', '%ss Neautorizuotas' );
define( '_ERR_TITLE_DESC_401', 'Užklausa reikalauja, kad vartotojas autorizuotųsi. Jei vartotojas autorizavosi ir mato šį pranešimą, tai reiškia, kad autorizacija buvo atmesta.' );
define( '_ERR_TITLE_402', '%s Užmokėjimas yra reikalingas ' );
define( '_ERR_TITLE_DESC_402', 'Šis kodas yra rezervuotas ateičiai.' );
define( '_ERR_TITLE_403', '%s Uždrausta' );
define( '_ERR_TITLE_DESC_403', 'Serveris gavo jūsų užklausą, tačiau atsisakė ją įvykdyti. Greičiausiai dėl to, kad jūs neautorizavotės.' );
define( '_ERR_TITLE_404', '%s Puslapis nerastas' );
define( '_ERR_TITLE_DESC_404', 'Serveris nerado nieko panašaus į %s adresą.' );
define( '_ERR_TITLE_405', '%s Metodas neleidžiamas' );
