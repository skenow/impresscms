...
class XoopsConfigItem extends XoopsObject
{
	 ...
	 * We need to know if the value will be used for "Show" of for "Edit"
	 */
    //function getConfValueForOutput()
    function getConfValueForOutput($format='N')
	/**
	 ...
	 */
    {
        ...
        case 'textarea':
            ...
            if ($format=='N' || $format=='n') {
            	return $myts->formatForML($this->getVar('conf_value', $format));
            }
            return $this->getVar('conf_value', $format);

        case 'text':
            if (isset($xoopsConfig) && ($format=='N' || $format=='n')) {
            	return $myts->formatForML($this->getVar('conf_value', $format));
            }
            return $this->getVar('conf_value', $format);
          	break;
