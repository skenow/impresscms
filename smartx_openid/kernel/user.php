...
class XoopsUser extends XoopsObject
{
    ...
    function XoopsUser($id = null)
    {
        ...
        $this->initVar('notify_method', XOBJ_DTYPE_OTHER, 2, false);            //mal
        ...
        $this->initVar('openid_url', XOBJ_DTYPE_TXTBOX);
...
class XoopsUserHandler extends XoopsObjectHandler
{
    ...
    function insert(&$user, $force = false)
    {
        ...
        if ($user->isNew()) {
            ...
            $whereclause = 'uid'." = ".$user->getVar('uid');
