...
define ('_NOT_ACTIVENOTIFICATIONSINFO', "You will find here the notifications set for your profile. Each time one of these events happen, your are notify by mail. You can delete the event for which you do not wish to be notified. Simply select the notifications you want to delete and then click on the <b>"._DELETE."</b> button.");
define ('_NOT_SELECT_INFO', 'You would like to be notified when something new is added? Select the notifications you would like to receive and hit the <b>Update Now</b> button! ');
?>
