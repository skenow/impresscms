...
// $Id$
//%%%%%%		File Name user.php 		%%%%%
define('_US_NOTREGISTERED','You did not yet registered to our site?  No problem, <a href="register.php">signup now</a>!');
...
#*#FINISH_INSCRIPTION#
define('_US_FINISHINSCRIPTION',"Please confirm the informations below. To change these informations, hit the <i>Back</i> button of your Browser. To complete your inscription, click on the <i>"._US_FINISH."</i> button.");


// %s is username. This is a subject for email
define('_US_USERKEYFOR','User activation key for %s');

define('_US_YOURREGISTERED','You are now registered. An email containing a user activation key has been sent to the email account you provided. Please follow the instructions in this email to activate your account. ');
...
// %s is a username
define('_US_PWDMAILED','Your new password has been mailed to you. Please follow the instructions provided in this message.');
define('_US_CONFMAIL','A message containing your new access information has been sent to you by email.');
...
define('_US_REALNAME','Your Real Name');
...
// Hack by marcan : More information on the registration process
define('_US_FILLTHISFORM', 'Please fill the following form in order to register on our site.');
define('_US_WHYFILLTHISFORM', "Once registered on our site, you will be able to : <br />  - Post messages in the forums<br />  - Post comments<br />  - Get notify by email when we update our site!<br />  - And so much more!");
define('_US_PLEASECONNECT', "Please enter your username and password in order to login to our site.");
define('_US_PLEASECONNECT2', "Once connected, you will have access to functionnalities reserved to registered usres!");
define('_US_EMAILCONFIRM', "Email confirmation");
define('_US_MAILNOTMATCH', "Both email adresses are not the same.");
define('_US_YOURINSCRIPTION', "Your registration on %s");
define('_US_NOTREGISTEREDSHORT',"<a href=\"register.php\">Signup now</a>!");
define('_US_EDITPROFILEINTRO',"You can edit any information of your profile by simply writing the right value in the edit box. Once you have made all necessary changes, dont forget to hit the <b>"._US_SAVECHANGES."</b> button.");
define('_US_CONNECTPROBLEM',"Connection problems?");
define('_US_CONNECTPROBLEM_TEXT',"Our site is using cookies to identify you when you log in. If you encounter some problems registering or loging in, please check your browser and firwall settings to allow cookies for this site.");
define('_US_CONNECT_TITLE', 'Login to our site');
define('_US_NOTIFICATIONS', 'Notifications');
define('_US_GET_VCARD', 'Add this user to<br/>your address book');
