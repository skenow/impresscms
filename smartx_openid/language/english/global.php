...
// Added by marcan
define("_HITS", "Hits");
define("_IMGMANAGER_INFO", "Select the image you would like to insert in the text area.");
define("_IMGMANAGER_UPLOAD_INFO", "Fill the following form in order to upload a new image.");
define("_IMGMANAGER_BACK", "Back  to the images");
define("_AUTOMATIC_LOGIN", "Logging in automatically...");

define("_MENU_USER_MENU", "User Menu");
define("_MENU_DOWNLOADS", "Downloads");
define("_MENU_LIBRARY", "Library");
define("_MENU_HOME", "Home");
define("_MENU_VACNT", "View Account");
define("_MENU_EACNT", "Edit Profile");
define("_MENU_NOTIF", "Notifications");
define("_MENU_LOUT", "Logout");
define("_MENU_INBOX", "Inbox");

define("_SELECT_LANGUAGE", "Language:");
define('_INBOX_TECHNOLOGY_DEVELOPED_BY', 'The INBOX Technology is developed by <a href="http://inboxinternational.com" target="_blank">INBOX Solutions</a> based on ' . XOOPS_VERSION . '' );
define("_COPY_XOOPS", "XOOPS &copy; 2001-2006 <a href='http://www.xoops.org/' target='_blank'>The XOOPS Project</a>");
define("_COPY_INBOX", "INBOX Technology &copy; 2004-2006 <a href='http://inboxinternational.com/' target='_blank'>INBOX International</a>");
?>