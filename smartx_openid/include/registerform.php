 ...
 */
$reg_form->addElement(new XoopsFormText(_US_REALNAME, "name", 25, 60, $myts->htmlSpecialChars($name)), true);
 // Adding the real name as a mandatory field on regisration form
...
if ($xoopsConfigUser['reg_dispdsclmr'] != 0 && $xoopsConfigUser['reg_disclaimer'] != '') {
  ...
  // MLPatch hack by marcan //
	...
	$disc_text = new XoopsFormTextarea('', 'disclaimer', str_replace("<br />","\n",$xoopsConfigUser['reg_disclaimer']), 8, 39);
