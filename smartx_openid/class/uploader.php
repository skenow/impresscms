	...
	**/
    ...
    function _copyFile($chmod)
    {
        ...
        if (isset($this->targetFileName)) {
            ...
            $this->savedFileName = $this->generateUniqueFilelName(strtolower($this->mediaName));
        }
    ...
    function generateUniqueFilelName($file_name) {
	    $title   = rawurlencode(strtolower($file_name));
