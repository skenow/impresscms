...
class XoopsFormTextDateSelect extends XoopsFormText
{
	...
	function render()
	{
		...
		/* Hack by marcan <InBox Solutions> for Location-Pelletier
		 * To prevent output of javascript at the top of a page
		 */
		ob_start();
		include_once XOOPS_ROOT_PATH.'/include/calendarjs.php';
		$js = ob_get_clean();
		/* End of Hack by marcan <InBox Solutions> for Location-Pelletier
		 * To prevent output of javascript at the top of a page
		 */		
		return "$js 
