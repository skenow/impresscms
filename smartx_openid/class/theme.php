...
class xos_opal_Theme {
   ...
   function xoInit( $options = array() ) {
		...
		$this->path = XOOPS_ROOT_PATH . '/themes/' . $this->folderName;
		$this->url = XOOPS_URL . '/themes/' . $this->folderName;
	...
	function checkCache() {
		...
		if ( $_SERVER['REQUEST_METHOD'] != 'POST' && $this->contentCacheLifetime ) {
			...
			$this->contentCacheId = $dirname . '|' . str_replace( XOOPS_URL, '', $_SERVER['REQUEST_URI'] );
	...
	function render( $canvasTpl = null, $pageTpl = null, $contentTpl = null, $vars = array() ) {
		...
		$header = $this->template->get_template_vars( 'xoops_module_header' );
    ...
    **/
	...
	function renderMetas( $type = null, $return = false ) {
		...
		if ( !isset($type) ) {
			...
			default:
				/**
				 * Hack by marcan for XOOPS Multilanguages
				 */
				...
				/**
				 * End of Hack by marcan for XOOPS Multilanguages
				 */
				break;
			}
		}
