...
if ( !is_object($xoopsUser) ) {
	...
	echo "<h2>" . _PM_PRIVATEMESSAGE . "</h2>";
	echo "<a href='viewpmsg.php'>". _PM_INBOX ."</a>&nbsp;>&nbsp;" . $pm_arr[0]->getVar("subject") . "";
	...
	if (empty($pm_arr)) {
		...
		echo "<form action='readpmsg.php' method='post' name='delete".$pm_arr[0]->getVar("msg_id")."'><table border='0' cellpadding='4' cellpadding='1' class='outer' width='100%'><tr><th colspan='2'>". _PM_FROM ."</td></tr><tr class='even'>\n";
