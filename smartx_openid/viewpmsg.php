...
if (!is_object($xoopsUser)) {
	...
	echo "<h2/>" . _PM_INBOX . "</h2>";
	echo "" . _PM_INBOX_INTRO . "";
	echo "<table style='padding-top: 5px;' border='0' cellspacing='1' cellpadding='4' width='100%' class='outer'>\n";
	...
	// End of Hack by marcan : More information on the PM section
