...
// TODO: need to span over multiple pages...???
	...
	foreach ($notifications as $n) {
		...
		if ($category != $prev_category) {
     	...
     	// MLPatch hack by marcan //
			...
			$modules[$modid]['categories'][$category] = array ('name'=>$myts->makeTareaData4Show($category), 'title'=>$myts->makeTareaData4Show($category_info['title']), 'items'=>array());
			// End of MLPatch hack by marcan //			
		}
		...
		if ($item != $prev_item) {
     	...
     	// MLPatch hack by marcan //
			...
			$modules[$modid]['categories'][$category]['items'][$item] = array ('id'=>$item, 'name'=>$myts->makeTareaData4Show($item_info['name']), 'url'=>$item_info['url'], 'notifications'=>array());
			// End of MLPatch hack by marcan //			
		}
  ...
  // Hack by marcan
	$xoopsTpl->assign ('lang_activenotificationsinfo', _NOT_ACTIVENOTIFICATIONSINFO);
