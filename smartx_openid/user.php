...
if ($op == 'main') {
    if ( !$xoopsUser ) {
        ...
        // Added by marcan
		$xoopsTpl->assign('lang_pleaseconnect', _US_PLEASECONNECT);
		$xoopsTpl->assign('lang_pleaseconnect2', _US_PLEASECONNECT2);
        $xoopsTpl->assign('lang_notregistershort', _US_NOTREGISTEREDSHORT);
        $xoopsTpl->assign('lang_connectproblem', _US_CONNECTPROBLEM);
        $xoopsTpl->assign('lang_connectproblem_text', _US_CONNECTPROBLEM_TEXT);
        $xoopsTpl->assign('lang_connect_title', _US_CONNECT_TITLE);
