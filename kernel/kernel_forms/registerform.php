<?php
// $Id: registerform.php,v 1.1 2007/03/16 02:44:13 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$reg_form->addElement( new ZariliaFormHidden( 'op', 'newuser' ) );
$reg_form->addElement( new ZariliaFormButtontray( 'submit', _SUBMIT ) );
