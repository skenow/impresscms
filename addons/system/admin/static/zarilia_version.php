<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:55 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['content'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=static", 'title' => _MD_AM_STATIC_MENU, 'group' => 'list', 'class' => 'content' );
