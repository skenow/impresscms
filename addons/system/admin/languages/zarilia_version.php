<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:37 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_LANGUAGE
    );

#$addonversion['name'] = _MD_AM_TRANSLATE;
#$addonversion['description'] = _MD_AM_TRANSLATE_DSC;
#$addonversion['author'] = _MD_AM_ADMIN_AUTHOR;
#$addonversion['credits'] = _MD_AM_ADMIN_CREDITS;
#$addonversion['license'] = "GPL see LICENSE";
#$addonversion['image'] = "translate_admin.png";
#
...
#$addonversion['adminpath'] = "index.php?fct=languages";
#$addonversion['category'] = ZAR_SYSTEM_LANGUAGE;
$addonversion['menu']['interface'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=languages&amp;op=translate", 'title' => _MD_AM_TRANSLATE_MENU, 'group'=>'languages', 'class' => 'translate' );
?>