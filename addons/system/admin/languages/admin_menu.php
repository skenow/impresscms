...
$menu_handler->addMenuTabs( $addonversion['adminpath']."&amp;op=list", "List Translations" );
$menu_handler->addMenuTabs( $addonversion['adminpath']."&amp;op=translate", "Create Translation" );
