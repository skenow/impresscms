<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:32 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_EVENTS
    );
$addonversion['menu']['misc'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=events", 'title' => _MD_AM_EVENTS_MENU, 'class' => 'events' );
