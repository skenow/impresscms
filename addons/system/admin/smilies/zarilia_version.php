<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:53 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_SMILE
    );

$addonversion['menu']['interface'][] =
array( 'url' => ZAR_URL . "/addons/system/index.php?fct=smilies",
    'title' => _MD_AM_SMLS_MENU,
	'class' => 'smilies'
    );
