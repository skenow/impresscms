<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:44 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['interface'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=multilanguage", 'title' => _MD_AM_MULTILANGUAGE_MENU, 'group' => 'languages', 'class' => 'locale' );
