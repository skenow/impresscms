<?php
// $Id: vars.php,v 1.1 2007/03/16 02:36:44 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
if ( !defined( 'XLANGUAGE_CONFIG_FILE' ) ) define( 'XLANGUAGE_CONFIG_FILE', ZAR_CACHE_PATH . '/xlanguage.php' );
 ...
 * first.
 */
$available_languages = array( 'ar' => array( 'ar([-_][[:alpha:]]{2})?|arabic', 'arabic' ),
