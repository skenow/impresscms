<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:15 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_CATEGORY
    );

$addonversion['menu']['content'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=category", 'title' => _MD_AM_CATEGORY_MENU, 'group' => 'lisitings', 'class' => 'content' );
