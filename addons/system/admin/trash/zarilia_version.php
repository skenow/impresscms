<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:59 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['content'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=trash", 'title' => _MD_AM_TRASH_MENU, 'group' => 'list', 'class' => 'trash' );
