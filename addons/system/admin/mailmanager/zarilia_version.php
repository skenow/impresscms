<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:38 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['users'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=mailmanager", 'title' => _MD_AM_MLUS_MENU, 'class' => 'usermail' );
?>