<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:52 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['misc'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=security", 'title' => _MD_AM_SECURITY_MENU, 'class' => 'security' );
