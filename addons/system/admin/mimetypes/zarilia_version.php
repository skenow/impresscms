<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:43 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_MIMETYPES
    );
$addonversion['menu']['media'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=mimetypes", 'title' => _MD_AM_MIMETYPE_MENU, 'class'=> 'filetypes' );
?>