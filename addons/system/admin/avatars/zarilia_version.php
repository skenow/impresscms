<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:12 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_AVATAR
    );
$addonversion['menu']['interface'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=avatars", 'title' => _MD_AM_AVATARS_MENU, 'class' => 'avatar' );
