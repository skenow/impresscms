<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:14 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_BLOCK
    );
$addonversion['menu']['interface'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=blocksadmin", 'title' => _MD_AM_BKAD_MENU, 'class' => 'blocks' );
?>