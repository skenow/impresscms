<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:57 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_TPLSET
    );
$addonversion['menu']['interface'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=tplsets", 'title' => _MD_AM_TPLSETS_MENU, 'class' => 'themes' );
