<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:48 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion['menu']['content'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=section", 'title' => _MD_AM_SECTION_MENU, 'group' => 'lisitings', 'class' => 'content' );
