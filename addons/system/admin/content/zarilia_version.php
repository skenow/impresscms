<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:18 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_STATIC
    );

$addonversion['menu']['content'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=content", 'title' => _MD_AM_CONTENT_MENU, 'group' => 'list','class' => 'content' );
