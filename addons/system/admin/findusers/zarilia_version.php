<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:33 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_FINDU
    );
$addonversion['menu']['users'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=findusers", 'title' => _MD_AM_FINDUSER_MENU, 'class' => 'usersearch' );
