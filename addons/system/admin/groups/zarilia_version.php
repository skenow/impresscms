<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:36 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'adminpath' => 'index.php?fct=groups',
    'category' => ZAR_SYSTEM_GROUP
    );
$addonversion['menu']['users'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=groups", 'title' => _MD_AM_ADGS_MENU, 'class' => 'usergroups' );
?>