<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:47 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_RSS
    );
$addonversion['menu']['content'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=rss", 'title' => _MD_AM_RSS_MENU, 'class' => 'rss' );
?>