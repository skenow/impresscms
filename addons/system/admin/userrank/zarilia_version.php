<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:37:02 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_URANK
    );
$addonversion['menu']['users'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=userrank", 'title' => _MD_AM_RANK_MENU, 'class' => 'userrank' );
