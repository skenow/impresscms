<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:39 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_MAILU
    );

#$addonversion['name'] = _MD_AM_MLUS;
#$addonversion['description'] = _MD_AM_MLUS_DSC;
#$addonversion['author'] = _MD_AM_ADMIN_AUTHOR;
#$addonversion['license'] = "GPL see LICENSE";
#$addonversion['image'] = "mailusers_admin.png";
#
...
#$addonversion['adminpath'] = "index.php?fct=mailusers";
#$addonversion['category'] = ZAR_SYSTEM_MAILU;
$addonversion['menu']['users'][] =  array( 'url' => ZAR_URL . "/addons/system/index.php?fct=mailusers", 'title' => _MD_AM_MLUS_MENU, 'class' => 'usermail' );
?>