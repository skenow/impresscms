<?php
// $Id: zarilia_version.php,v 1.1 2007/03/16 02:36:17 catzwolf Exp $
// ------------------------------------------------------------------------ //
...
$addonversion = array( 'name' => _MA_INFO_NAME,
    ...
    'category' => ZAR_SYSTEM_COMMENT
    );
$addonversion['menu']['misc'][] = array( 'url' => ZAR_URL . "/addons/system/index.php?fct=comments", 'title' => _MD_AM_COMMENTS_MENU, 'class' => 'comment' );
?>