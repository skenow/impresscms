<?php
// $Id: errors.php,v 1.1 2007/03/16 02:38:02 catzwolf Exp $
// %%%%%%	Admin Addons Name  AdminGroup 	%%%%%
define( '_MA_AD_ERRORS_ID', '#' );
define( '_MA_AD_ERRORS_NO', 'Error #' );
define( '_MA_AD_ERRORS_IP', 'IP Address' );
define( '_MA_AD_ERRORS_DATE', 'Error Date' );
define( '_MA_AD_ERRORS_REPORT', 'Error Report' );

define( '_MA_AD_SELECT_DATE', 'Select Date' );
define( '_MA_AD_ESECTION_CREATE', 'Create Error' );

/*Addons Information*/
define( '_MA_INFO_NAME', 'Error Administration' );
define( '_MA_INFO_DESCRIPTION', '' );
define( '_MA_INFO_AUTHOR', 'Zarilia Project' );
define( '_MA_INFO_LICENSE', 'GPL see LICENSE' );
define( '_MA_INFO_IMAGE', 'errors_admin.png' );
...
define( '_MA_INFO_PATH', 'index.php?fct=errors' );
