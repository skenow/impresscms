<?php
define( '_MD_AM_PHPINFOHEADING', 'PHP Information' );
define( '_MD_AM_ZARILIAINFOHEADING', 'Code Plus Information' );

define( '_MD_CINFO_GENERAL', 'GENERAL' );
define( '_MD_CINFO_CONFIGURATION', 'CONFIGURATION' );
define( '_MD_CINFO_ADDONS', 'ADDONS' );
define( '_MD_CINFO_ENVIRONMENT', 'ENVIRONMENT' );
define( '_MD_CINFO_VARIABLES', 'VARIABLES' );
define( '_MD_CINFO_LICENSE', 'LICENSE' );

/*Addons Information*/
define( '_MA_INFO_NAME', 'PHP Information' );
define( '_MA_INFO_DESCRIPTION', '' );
define( '_MA_INFO_AUTHOR', 'Zarilia Project' );
define( '_MA_INFO_LICENSE', 'GPL see LICENSE' );
define( '_MA_INFO_IMAGE', 'info_admin.png' );
/**/
...
define( '_MA_INFO_PATH', 'index.php?fct=coreinfo' );
