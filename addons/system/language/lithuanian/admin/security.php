<?php
// $Id: security.php,v 1.1 2007/03/16 02:38:03 catzwolf Exp $
// %%%%%%	Admin Addons Name  AdminGroup 	%%%%%
define( '_MA_AD_SECURITY_ID', '#' );
define( '_MA_AD_SECURITY_TITLE', 'Title' );
define( '_MA_AD_SECURITY_LOGIN', 'Login' );
define( '_MA_AD_SECURITY_IP', 'IP Address' );
define( '_MA_AD_SECURITY_DATE', 'Date' );
/*Addons Information*/
define( '_MA_INFO_NAME', 'Security Administration' );
define( '_MA_INFO_DESCRIPTION', '' );
define( '_MA_INFO_AUTHOR', 'Zarilia Project' );
define( '_MA_INFO_LICENSE', 'GPL see LICENSE' );
define( '_MA_INFO_IMAGE', 'security_admin.png' );
...
define( '_MA_INFO_PATH', 'index.php?fct=security' );
