...
define('NEWS_FPDF_PATH',ZAR_ROOT_PATH.'/addons/'.$zariliaAddon->getVar('dirname').'/fpdf');
define('FPDF_FONTPATH',NEWS_FPDF_PATH.'/font/');

require NEWS_FPDF_PATH.'/gif.php';
require NEWS_FPDF_PATH.'/fpdf.php';

if(is_readable(NEWS_FPDF_PATH.'/language/'.$zariliaConfig['language'].'.php')){
	include_once(NEWS_FPDF_PATH.'/language/'.$zariliaConfig['language'].'.php');
